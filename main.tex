...
\begin{center}
  \csvautobooktabular{data/report_data/NN_optimal_parameters_small_sigmoid.csv}
\end{center}

\begin{center}
  \csvautobooktabular{data/report_data/NN_optimal_parameters_large_relu.csv}
\end{center}

\begin{center}
  \csvautobooktabular{data/report_data/NN_optimal_parameters_large_leaky_relu.csv}
\end{center}
