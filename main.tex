...
To validate the accuracy of our own logistic regression, we also implmented a logistic regression model from Scikit Learn. This was implmented with both Stochastic Average Gradient descent and Newton´s method as solvers. 
