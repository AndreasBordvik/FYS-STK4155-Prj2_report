...
\subsubsection{Optimal parameters}
For finding optimal hyperparameters we utilized the grid search as shown in table xx. This grid search is using on the two different model architectures shown  in figure xx. We named the two architectures as small and large, and performed the grid search on both
\subsubsection{Parameters and model complexity}
ay
\subsubsection{Performance of activation functions}
ay
