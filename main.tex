...
\subsection{Arificial Neural Net Vs PyTorch}
\begin{figure*}
  \vspace*{-2.5cm}
  \subfloat[Own NN model - Confusion Matrix\label{fig:EX_D_homebrew_conf_matrix}]{
    \includegraphics[width=.89\textwidth]{figures/EX_D_homebrew_conf_matrix.pdf}
  }\\
  \vspace*{-0.45cm}
  \subfloat[PyTorch model - Confusion Matrix\label{fig:EX_D_torch_conf_matrix}]{
    \includegraphics[width=.89\textwidth]{figures/EX_D_torch_conf_matrix.pdf}
  }
  \caption{bla blab\label{fig:conf_matrix}}
\end{figure*}

\subsection{Logistic Regression: SGD Vs NRM}
\begin{figure*}
  \vspace*{-2.5cm}
  \subfloat[Logistic Regression with NRM - Confusion Matrix\label{fig:EX_E_logreg_nrm_confmat}]{
    \includegraphics[width=.89\textwidth]{figures/EX_E_logreg_nrm_confmat.pdf}
  }\\
  \vspace*{-0.45cm}
  \subfloat[Logistic Regression with SGD - Confusion Matrix\label{fig:EX_E_logreg_sgd_confmat.pdf}]{
    \includegraphics[width=.89\textwidth]{figures/EX_E_logreg_sgd_confmat.pdf}
  }
  \caption{bla bla bla \label{fig:conf_matrix}}
\end{figure*}


\subsection{ROC Curve}
\begin{figure*}
  \includegraphics[width=\textwidth]{figures/EX_E_roc_curve.pdf}
...
In studying the Wisconsin Breast Cancer Data, 
